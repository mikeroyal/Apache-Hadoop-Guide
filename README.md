...
#### A guide covering Apache Hadoop including the applications, libraries and tools that will make you better and more efficient with Apache Hadoop development.
...
1. [Apache Hadoop Learning Resources](https://github.com/mikeroyal/Apache-Hadoop-Guide#Apache-Hadoop-learning-resources)

2. [Apache Hadoop Tools, Libraries, and Frameworks](https://github.com/mikeroyal/Apache-Hadoop-Guide#Apache-Hadoop-tools-libraries-and-frameworks)

3. [Machine Learning](https://github.com/mikeroyal/Apache-Hadoop-Guide#machine-learning)

4. [Algorithms](https://github.com/mikeroyal/Apache-Hadoop-Guide#Algorithms)

5. [Deep Learning Development](https://github.com/mikeroyal/Apache-Hadoop-Guide#Deep-Learning-Development)

6. [Reinforcement Learning Development](https://github.com/mikeroyal/Apache-Hadoop-Guide#Reinforcement-Learning-Development)

7. [Computer Vision Development](https://github.com/mikeroyal/Apache-Hadoop-Guide#computer-vision-development)

8. [Natural Language Processing (NLP) Development](https://github.com/mikeroyal/Apache-Hadoop-Guide#nlp-development)

9. [Bioinformatics](https://github.com/mikeroyal/Apache-Hadoop-Guide#bioinformatics)

10. [Databases](https://github.com/mikeroyal/Apache-Hadoop-Guide#databases)

11. [CUDA Development](https://github.com/mikeroyal/Apache-Hadoop-Guide#cuda-development)

12. [MATLAB Development](https://github.com/mikeroyal/Apache-Hadoop-Guide#matlab-development)

13. [Java Development](https://github.com/mikeroyal/Apache-Hadoop-Guide#java-development)

14. [C/C++ Development](https://github.com/mikeroyal/Apache-Hadoop-Guide#cc-development)

15. [C# Development](https://github.com/mikeroyal/Apache-Hadoop-Guide#c-development)

16. [Python Development](https://github.com/mikeroyal/Apache-Hadoop-Guide#python-development)

17. [Scala Development](https://github.com/mikeroyal/Apache-Hadoop-Guide#scala-development)

18. [R Development](https://github.com/mikeroyal/Apache-Hadoop-Guide#r-development)


# Apache Hadoop Learning Resources
[Back to the Top](https://github.com/mikeroyal/Apache-Hadoop-Guide#table-of-contents)

[Apache Hadoop®](https://hadoop.apache.org/) is an open source software library is a framework that allows for the distributed processing of large data sets across clusters of computers using simple programming models. The Hadoop ecosystem includes related software and utilities, including Apache Hive, Apache HBase, Spark, Kafka, and many others.
...
[Apache Hadoop | IBM](https://www.ibm.com/analytics/hadoop)
...
[Top Hadoop Courses Online | Coursera](https://www.coursera.org/courses?query=hadoop&amp;page=1)

[Introduction to Apache HIVE Course | Coursera](https://www.coursera.org/lecture/hadoop/introduction-to-apache-hive-0AToF)

[Top Hadoop Courses Online | Udemy](https://www.udemy.com/topic/hadoop/)

[Hadoop Basic Course for Beginners | Udemy](https://www.udemy.com/course/hadoop-basic-course-for-beginners-to-professionals/)

[Learn Hadoop with Online Courses and Lessons | edX](https://www.edx.org/learn/hadoop)

[Learning Hadoop Online Class | LinkedIn Learning](https://www.linkedin.com/learning/learning-hadoop-2)

[Apache Hadoop Big Data Training | Awesome Open Source](https://awesomeopensource-newprod.herokuapp.com/project/tertiarycourses/ApacheHadoop)

[Online Apache Hadoop Courses | Harvard University](https://online-learning.harvard.edu/subject/apache-hadoop)
...
# Apache Hadoop Tools, Libraries, and Frameworks
[Back to the Top](https://github.com/mikeroyal/Apache-Hadoop-Guide#table-of-contents)
...
[Apache Hadoop MapReduce](https://hadoop.apache.org/docs/current/hadoop-mapreduce-client/hadoop-mapreduce-client-core/MapReduceTutorial.html) is a software framework for writing jobs that process vast amounts of data. Input data is split into independent chunks. Each chunk is processed in parallel across the nodes in your cluster.

[Hadoop Streaming](https://hadoop.apache.org/docs/current/hadoop-streaming/HadoopStreaming.html) is a utility that comes with the Hadoop distribution. The utility allows you to create and run Map/Reduce jobs with any executable or script as the mapper and/or the reducer.
...
[Apache Avro™](https://avro.apache.org/docs/current/) is a data serialization system.
...
- [x] If would you like to contribute to this guide simply make a [Pull Request](https://github.com/mikeroyal/Apache-Hadoop-Guide/pulls).
